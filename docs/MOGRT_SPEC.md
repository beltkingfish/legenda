...
| `mogrt/legenda-teleprompter-v1.mogrt` | Teleprompter (strategy 1: `Top Row` two-instance) | authored + contract-verified; **renderer support built** (awaiting live verify) |
